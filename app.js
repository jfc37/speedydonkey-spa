...
function setupCsp(app) {
    ...
    var scriptSrc = ["'self'", "''unsafe-inline'", "'sha256-KxtbH1VwpjLMD-dX6JwdnF45uYE_xmwRym1XFjtAifg='", "'sha256-SCss7iChG-zqlqUaonanbpCZUyj_jbf5LKHb5pPDpLU='", 'www.google-analytics.com', 'cdn.au.auth0.com', 'jfc.au.auth0.com', 'jfc-dev.au.auth0.com'];
    ...
    var connectSrc = ["'self'", apiUrl, 'jfc.au.auth0.com', 'jfc-dev.au.auth0.com'];
